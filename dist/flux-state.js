(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("flux"));
...
var _Store = __webpack_require__(/*! ./v2/Store */ "./src/v2/Store.js");

var _Store2 = _interopRequireDefault(_Store);

var _Event = __webpack_require__(/*! ./v2/Event */ "./src/v2/Event.js");
...
exports.default = { DashView: _index2.default, DashStore: _Store2.default, DashEvent: _Event2.default, dispatchEvent: _index3.dispatchEvent };
...
var Event = function () {
    ...
    function Event(name, transformers) {
        ...
        if (!Array.isArray(transformers)) throw new Error("Transformers must be an Array");

        if (transformers.length == 0) throw new Error("Transformers Array shouldn't be empty");
...
var _Event = __webpack_require__(/*! ./Event */ "./src/v2/Event.js");

var _Event2 = _interopRequireDefault(_Event);

var _index = __webpack_require__(/*! ./index */ "./src/v2/index.js");
...
function validateText(text) {
    if (typeof text === "undefined") throw new Error("text can't be undefined");
    if (text === null) throw new Error("text can't be null");
    if (text === "") throw new Error("text can't be an empty string");
...
exports.dispatchEvent = exports.allEvents = undefined;
...
var handleDispatch = function handleDispatch(_ref) {
    ...
    if (!atLeastDistpatchOneEvent) throw new Error("No event: " + eventName + " exists in the System");
};
